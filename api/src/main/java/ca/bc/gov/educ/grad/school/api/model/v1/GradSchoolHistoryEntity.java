...
@Builder
@Entity
@Table(name = "GRAD_SCHOOL_HISTORY")
public class GradSchoolHistoryEntity {
  @Id
  @GeneratedValue(generator = "UUID")
  @GenericGenerator(name = "UUID", strategy = "org.hibernate.id.UUIDGenerator", parameters = {
          @org.hibernate.annotations.Parameter(name = "uuid_gen_strategy_class", value = "org.hibernate.id.uuid.CustomVersionOneStrategy")})
  @Column(name = "GRAD_SCHOOL_HISTORY_ID", unique = true, updatable = false, columnDefinition = "BINARY(16)")
  private UUID gradSchoolHistoryID;

  @Basic
  @Column(name = "GRAD_SCHOOL_ID", columnDefinition = "BINARY(16)")
