...
import ca.bc.gov.educ.grad.school.api.exception.PreConditionFailedException;
...
@SpringBootTest
@Slf4j
public class GradSchoolNumberGenerationServiceTest {
    ...
    public void tearDown() {
        ...
        gradSchoolRepository.deleteAll();
    ...
    public void testCreateSchool_givenSchoolCodePUBLIC_givenFacilityCodeDISTLEARN_shouldCreateValidSchoolNumber() {
        ...
        this.gradSchoolRepository.save(schoolEntity);
    ...
    private GradSchoolEntity createSchoolData(String schoolCategory, String facilityTypeCode) {
        return GradSchoolEntity.builder().schoolNumber("12334").displayName("School Name").openedDate(LocalDateTime.now().minusDays(1).withNano(0)).schoolCategoryCode(schoolCategory)
    ...
    private GradSchoolEntity createSchoolDataWithSchoolNumber(String schoolNumber, String schoolCategory, String facilityTypeCode) {
        return GradSchoolEntity.builder().schoolNumber(schoolNumber).displayName("School Name").openedDate(LocalDateTime.now().minusDays(1).withNano(0)).schoolCategoryCode(schoolCategory)
                .schoolOrganizationCode("TWO_SEM").facilityTypeCode(facilityTypeCode).website("abc@sd99.edu").createDate(LocalDateTime.now().withNano(0))
                .updateDate(LocalDateTime.now().withNano(0)).createUser("TEST").updateUser("TEST").build();
    }
