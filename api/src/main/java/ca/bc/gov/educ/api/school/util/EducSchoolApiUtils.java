...
public class EducSchoolApiUtils {
    ...
    public static String formatDate (Date date) {
        ...
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(EducSchoolApiConstants.DEFAULT_DATE_FORMAT);
    ...
    public static Date parseTraxDate (String sessionDate) {
        ...
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(EducSchoolApiConstants.TRAX_DATE_FORMAT);
        Date date = new Date();
