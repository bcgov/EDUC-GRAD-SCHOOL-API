package ca.bc.gov.educ.grad.school.api.messaging;
...
public class NatsConnection implements Closeable {
  ...
  public NatsConnection(final ApplicationProperties applicationProperties) throws IOException, InterruptedException {
    this.natsCon = connectToNats(applicationProperties.getServer(), applicationProperties.getNatsMaxReconnect(), applicationProperties.getConnectionName());
  }
