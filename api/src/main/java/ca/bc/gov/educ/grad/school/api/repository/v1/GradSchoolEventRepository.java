...
public interface GradSchoolEventRepository extends JpaRepository<GradSchoolEventEntity, UUID>, JpaSpecificationExecutor<GradSchoolEventEntity> {
    ...
    List<GradSchoolEventEntity> findByEventStatusAndEventTypeIn(String eventStatus, List<String> eventTypes);
    ...
    List<GradSchoolEventEntity> findAllByEventStatusAndCreateDateBeforeAndEventTypeNotInOrderByCreateDate(String eventStatus, LocalDateTime createDate, int limit, List<String> eventTypes);
}
