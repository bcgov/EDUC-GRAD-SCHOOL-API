...
@Builder
@Entity
@Table(name = "GRAD_SCHOOL_EVENT")
@Data
@DynamicUpdate
public class GradSchoolEventEntity {
  @Id
   ...
   */
  public static class GradSchoolEventEntityBuilder {
    /**
     ...
     */
    public GradSchoolEventEntity.GradSchoolEventEntityBuilder eventPayload(String eventPayload) {
